...
class AuditLog(BaseModel):
    ...
    session_id: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        doc="Session ID when the action was performed"
    )
    ...
    resource_identifier: Mapped[Optional[str]] = mapped_column(
        String(255),
        nullable=True,
        doc="Human-readable identifier of the resource"
    )
    ...
    event_data: Mapped[Dict[str, Any]] = mapped_column(
        ...
        nullable=False,
        default=dict,
        doc="Additional event data and context"
    )
    
    before_state: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        doc="State of the resource before the action"
    )
    
    after_state: Mapped[Optional[Dict[str, Any]]] = mapped_column(
        JSON,
        nullable=True,
        doc="State of the resource after the action"
    )
    ...
    request_id: Mapped[Optional[str]] = mapped_column(
        String(100),
        nullable=True,
        doc="Unique request ID for correlation"
    )
    ...
    error_code: Mapped[Optional[str]] = mapped_column(
        String(50),
        nullable=True,
        doc="Error code if the action failed"
    )
...
class AuditEvent(BaseModel):
    ...
    event_summary: Mapped[Dict[str, Any]] = mapped_column(
        ...
        nullable=False,
        default=dict,
        doc="Summary of the event and its impact"
    )
    
    resources_affected: Mapped[int] = mapped_column(
        nullable=False,
        default=0,
        doc="Number of resources affected by this event"
    )
    ...
    correlation_id: Mapped[str] = mapped_column(
        String(100),
        nullable=False,
        doc="Correlation ID linking related audit logs"
    )
...
class AuditRetentionPolicy(BaseModel):
    ...
    name: Mapped[str] = mapped_column(
        ...
        nullable=False,
        unique=True,
        doc="Name of the retention policy"
    )
    ...
    retention_days: Mapped[int] = mapped_column(
        nullable=False,
        doc="Number of days to retain audit logs"
    )
    
    archive_after_days: Mapped[Optional[int]] = mapped_column(
        nullable=True,
        doc="Number of days after which to archive logs"
    )
    
    compression_enabled: Mapped[bool] = mapped_column(
        nullable=False,
        default=True,
        doc="Whether to compress archived logs"
    )
    
    is_active: Mapped[bool] = mapped_column(
        nullable=False,
        default=True,
        doc="Whether this policy is active"
    )
    
    last_cleanup_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
        doc="Last time cleanup was performed"
    )
