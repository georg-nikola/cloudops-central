...
class CostRecord(BaseModel):
    ...
    service_name: Mapped[str] = mapped_column(
        String(200),
        nullable=False,
        doc="Name of the cloud service (EC2, S3, etc.)"
    )
    
    resource_type: Mapped[str] = mapped_column(
        String(100),
        nullable=False,
        doc="Type of resource generating the cost"
    )
    ...
    billing_account_id: Mapped[Optional[str]] = mapped_column(
        String(100),
        nullable=True,
        doc="Cloud provider billing account ID"
    )
    
    project_id: Mapped[Optional[str]] = mapped_column(
        String(100),
        nullable=True,
        doc="Cloud provider project/subscription ID"
    )
...
class CostBudget(NamedModel):
    ...
    scope_filters: Mapped[Dict[str, Any]] = mapped_column(
        ...
        nullable=False,
        default=dict,
        doc="Filters defining the budget scope"
    )
    ...
    end_date: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True),
        nullable=True,
        doc="Budget end date (null for ongoing)"
    )
    ...
    forecasted_spend: Mapped[Optional[Decimal]] = mapped_column(
        Numeric(12, 2),
        nullable=True,
        doc="Forecasted spending for the period"
    )
...
class CostAlert(NamedModel):
    ...
    resolved_by: Mapped[Optional[uuid.UUID]] = mapped_column(
        UUID(as_uuid=True),
        nullable=True,
        doc="ID of the user who resolved the alert"
    )
...
class CostOptimization(NamedModel):
    ...
    current_cost: Mapped[Decimal] = mapped_column(
        Numeric(10, 2),
        nullable=False,
        doc="Current monthly cost"
    )
    
    potential_savings: Mapped[Decimal] = mapped_column(
        Numeric(10, 2),
        nullable=False,
        doc="Potential monthly savings"
    )
    
    savings_percentage: Mapped[Decimal] = mapped_column(
        Numeric(5, 2),
        nullable=False,
        doc="Savings as percentage of current cost"
    )
    ...
    recommendation: Mapped[str] = mapped_column(
        Text,
        nullable=False,
        doc="Detailed optimization recommendation"
    )
    ...
    implementation_effort: Mapped[str] = mapped_column(
        ...
        nullable=False,
        default="medium",
        doc="Implementation effort level"
    )
    ...
    optimization_details: Mapped[Dict[str, Any]] = mapped_column(
        ...
        nullable=False,
        default=dict,
        doc="Detailed optimization data and metrics"
    )
