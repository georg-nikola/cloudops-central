...
class Policy(NamedModel):
    ...
    policy_type: Mapped[PolicyType] = mapped_column(
        Enum(PolicyType), nullable=False, doc="Type/category of the policy"
    )
    ...
    version: Mapped[str] = mapped_column(
        String(50), nullable=False, default="1.0.0", doc="Policy version"
    )

    policy_code: Mapped[str] = mapped_column(
        Text, nullable=False, doc="Policy implementation code (OPA Rego, custom, etc.)"
    )
    ...
    parameters: Mapped[Dict[str, Any]] = mapped_column(
        JSON, nullable=False, default=dict, doc="Configurable parameters for the policy"
    )

    remediation_actions: Mapped[Dict[str, Any]] = mapped_column(
        JSON, nullable=False, default=dict, doc="Automated remediation actions"
    )

    documentation_url: Mapped[Optional[str]] = mapped_column(
        String(500), nullable=True, doc="URL to policy documentation"
    )
...
class PolicyRule(NamedModel):
    ...
    parameters: Mapped[Dict[str, Any]] = mapped_column(
        JSON, nullable=False, default=dict, doc="Rule-specific parameters"
    )

    error_message: Mapped[str] = mapped_column(
        Text, nullable=False, doc="Error message shown when rule fails"
    )

    remediation_hint: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True, doc="Hint for how to remediate violations"
    )

    is_active: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=True, doc="Whether this rule is active"
    )

    order_index: Mapped[int] = mapped_column(
        nullable=False, default=0, doc="Order of execution for this rule"
    )
...
class PolicyViolation(NamedModel):
    ...
    resource_type: Mapped[str] = mapped_column(
        String(100), nullable=False, doc="Type of resource that violated the policy"
    )

    resource_identifier: Mapped[str] = mapped_column(
        String(255), nullable=False, doc="Identifier of the violating resource"
    )
    ...
    severity: Mapped[PolicySeverity] = mapped_column(
        Enum(PolicySeverity), nullable=False, doc="Severity of this violation"
    )
    ...
    resolved_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True, doc="When the violation was resolved"
    )
    ...
    resolution_notes: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True, doc="Notes about how the violation was resolved"
    )
    ...
    suppression_reason: Mapped[Optional[str]] = mapped_column(
        Text, nullable=True, doc="Reason for suppressing the violation"
    )
    ...
    remediation_details: Mapped[Dict[str, Any]] = mapped_column(
        JSON, nullable=False, default=dict, doc="Details about remediation attempts"
    )
...
class PolicyExemption(NamedModel):
    ...
    resource_pattern: Mapped[str] = mapped_column(
        String(500), nullable=False, doc="Pattern matching resources to exempt"
    )

    exemption_reason: Mapped[str] = mapped_column(
        Text, nullable=False, doc="Reason for the exemption"
    )

    expires_at: Mapped[Optional[datetime]] = mapped_column(
        DateTime(timezone=True), nullable=True, doc="When this exemption expires"
    )
    ...
    is_active: Mapped[bool] = mapped_column(
        Boolean, nullable=False, default=True, doc="Whether this exemption is active"
    )
